...
export default function Dashboard() {
  ...
  const { accountData, isLoading, refetch } = useUserAccountData();
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 animate-fade-in">
              <Card className="glass-card hover-lift transition-all duration-300 border-0 overflow-hidden relative group p-6">
                ...
                <CardContent className="pt-0">
                  <div className="text-4xl font-bold text-gray-900 dark:text-white mb-2 group-hover:scale-105 transition-transform duration-300">
                    {collateralVisible ? (accountData ? formatValue(accountData.totalCollateralETH, true) : '0.00') : '****'} <span className="text-lg font-medium text-gray-600 dark:text-gray-400">USDC</span>
                  </div>
              ...
              <Card className="glass-card hover-lift transition-all duration-300 border-0 overflow-hidden relative group p-6">
                ...
                <CardContent className="pt-0">
                  <div className="text-4xl font-bold text-gray-900 dark:text-white mb-2 group-hover:scale-105 transition-transform duration-300">
                    {debtVisible ? (accountData ? formatValue(accountData.totalDebtETH, true) : '0.00') : '****'} <span className="text-lg font-medium text-gray-600 dark:text-gray-400">USDC</span>
                  </div>
              ...
              <Card className="glass-card hover-lift transition-all duration-300 border-0 overflow-hidden relative group p-6">
                ...
                <CardContent className="pt-0">
                  <div className="text-4xl font-bold text-gray-900 dark:text-white mb-2 group-hover:scale-105 transition-transform duration-300">
                    {borrowVisible ? (accountData ? formatValue(accountData.availableBorrowsETH, true) : '0.00') : '****'} <span className="text-lg font-medium text-gray-600 dark:text-gray-400">USDC</span>
                  </div>
